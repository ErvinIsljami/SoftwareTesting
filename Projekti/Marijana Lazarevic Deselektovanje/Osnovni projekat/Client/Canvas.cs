...
namespace Client
{
    ...
    public partial class Canvas : Form
    {
        ...
        internal bool IsChecked_btnSelectProp { get => IsChecked_btnSelect; set => IsChecked_btnSelect = value; }
        internal bool IsChecked_btnRectRedProp { get => IsChecked_btnRectRed; set => IsChecked_btnRectRed = value; }
        internal bool IsChecked_btnRectBlueProp { get => IsChecked_btnRectBlue; set => IsChecked_btnRectBlue = value; }
        ...
        internal void pnlCenter_MouseClickWrapper(int x, int y, int clicks, int delta)
        {
            pnlCenter_MouseClick(null, new MouseEventArgs(MouseButtons.Left, clicks, x, y, delta));
        }
