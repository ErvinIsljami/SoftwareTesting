...
{
    [Serializable]
    public class RectangleBlue : Rectangle_Object
    {
        ...
        public RectangleBlue(int x, int y)
        {
            this.Name = "Rectangle Blue";
            this.X = x;
            this.Y = y;
            this.Selected = false;
            this.EventList = new List<Rectangle_Object>();
        ...
        public RectangleBlue(int x, int y, int movingHelperX, int movingHelperY)
        {
            this.Name = "Rectangle Blue";
            this.X = x;
            this.Y = y;
        ...
        public RectangleBlue(int x, int y, bool selected)
        {
            this.Name = "Rectangle Blue";
            this.X = x;
            this.Y = y;
        ...
        public RectangleBlue(bool moved, int x, int y)
        {
            this.Name = "Rectangle Blue";
            this.X = x;
            this.Y = y;
        ...
        public RectangleBlue(int x, int y, bool selected, bool deleted)
        {
            this.Name = "Rectangle Blue";
            this.X = x;
            this.Y = y;
        ...
        public RectangleBlue(int x, int y, bool selected, bool deleted, bool moved, Guid username, int movingHelperX, int movingHelperY, bool isUndo, bool isRedo) : this(x, y, selected, deleted)
        {
            this.Moved = moved;
